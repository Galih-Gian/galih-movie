...
const NavbarComponent = () => {
  return (
    <div className="md:flex md:justify-between items-center px-2 py-5">
      <div>
        <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl text-center text-slate-200 font-bold">Movie G-T<span className="ml-3"><i className="fa-solid fa-film"></i></span></h1>
      </div>
